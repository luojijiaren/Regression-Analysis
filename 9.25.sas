data SENIC;
 input ID yprime x1 x2 x3 x4 x5 x6 x7 x8 x9 x10;
logy=log10(y);
cards;
...
ods graphics on; *Needed only to get high quality graphs in SAS 9.4;
proc reg data=SENIC plot=CriterionPanel;
 model yprime=x1-x5 x8 x9 x10/selection=cp;
run;
